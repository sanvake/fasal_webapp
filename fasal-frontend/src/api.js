...
export const getMyList = async () => api.get("/getListByUser",  { headers: {"Authorization" : localStorage.getItem("token")} });
export const user = async (user_id) => api.get(`/getListByUser?user_id=${user_id}`);